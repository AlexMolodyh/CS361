...
public class QuickMergeSort
{
    ...
    {
        arrayContainer = new int[10000000];
        copyContainer = Arrays.copyOf(arrayContainer, arrayContainer.length);
        arrayHelper = new int[10000000];
    }

    public QuickMergeSort(int size)
    {
    ...
    public QuickMergeSort(int[] array)
    {
    ...
    {
        for(int i = 0; i < copyContainer.length; i++)
        {
            copyContainer[i] = (int) (Math.random() * 1001 + 1);
        }
    }
    ...
    public void mergeSort()
    {
        ...
        auxMergeSort(copyContainer, 0, copyContainer.length - 1);
    ...
    public void quickSort()
    {
        ...
        auxQuickSort(copyContainer, 0, copyContainer.length - 1);
